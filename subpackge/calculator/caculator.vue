	...
	<view class="digit-keyboard">
      ...
      <u-line color="info" length='0'/>
			...
			<view class="number-area">
				<view class="item" v-if='showToday' style="color: #5A9BF8;" @click='clickPick'>
					今天
				</view>
          ...
          <uni-icons type="clear" size="36"></uni-icons>
				</view>
				...
				<!-- 乘 -->
				<view class="item" @tap="modifyNum('operator','*')">*</view>
				<view class="item" @tap="finish" style="background-color: #579AFA;color: white;">完成</view>
			</view>
		</view>
